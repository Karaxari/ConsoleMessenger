...
# После неудачной попытки авторизоваться повторно, забросил эту идею. Так как обещали новую программу для связи, но ссылку я так и не получил на e-mail.
...
# Описание идеи проста: мини мессенджер с сохранением истории общения

# Описание пользовательских типов и функций примедено в коде коментариями, а также попыткой написать читабельный код - Очень жду развернутой оченки стиля написания кода, не хочу спагети писать 
...
# Для удобства пользования реализованы консольные интерфейсы с инструкциями. А также обработка ввода данных пользователем, чтобы исключить непредаиденнве ситуации ввода данных.
